...
def start_forwarding_recent_unread_notifications(
    period_sec=60, lower_bound_days=30, upper_bound_minutes=5
):
    """
    Starts a 'daemon' greenlet that will run for
    ...
    # Listens on SIGQUIT to kill the 'daemon' greenet so that it does not become a zombie
    # , delaying application shutdown
